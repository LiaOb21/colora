...
rule run_purge_dups:
    ...
    output:
        ...
        purged_fasta = "results/purge_dups/purged.fa"
    conda:
    ...
    shell:
        ...
        split_fa results/assemblies/hifiasm/hifiasm.asm.bp.p_ctg.fa > hifiasm.asm.split
        ...
        get_seqs -e dups.bed results/hifiasm/hifiasm.asm.bp.p_ctg.fa > purged.fa
